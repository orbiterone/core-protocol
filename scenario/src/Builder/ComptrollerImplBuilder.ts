...
export async function buildComptrollerImpl(
  ...
  comptrollerImplData: ComptrollerImplData;
}> {
  const fetchers = [
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      async (world, { name }) => ({
        invokation: await ComptrollerScenarioG1Contract.deploy<ComptrollerImpl>(
          world,
          from,
          []
        ),
    ...
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      [new Arg("name", getStringV)],
      async (world, { name }) => ({
        invokation: await ComptrollerScenarioG2Contract.deploy<ComptrollerImpl>(
          world,
          from,
          []
        ),
    ...
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      [new Arg("name", getStringV)],
      async (world, { name }) => ({
        invokation: await ComptrollerScenarioG3Contract.deploy<ComptrollerImpl>(
          world,
          from,
          []
        ),
    ...
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      [new Arg("name", getStringV)],
      async (world, { name }) => ({
        invokation: await ComptrollerScenarioG4Contract.deploy<ComptrollerImpl>(
          world,
          from,
          []
        ),
    ...
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      [new Arg("name", getStringV)],
      async (world, { name }) => ({
        invokation: await ComptrollerScenarioG5Contract.deploy<ComptrollerImpl>(
          world,
          from,
          []
        ),
    ...
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      [new Arg("name", getStringV)],
      async (world, { name }) => ({
        invokation: await ComptrollerScenarioG6Contract.deploy<ComptrollerImpl>(
          world,
          from,
          []
        ),
    ...
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      [new Arg("name", getStringV)],
      async (world, { name }) => ({
        invokation: await ComptrollerScenarioContract.deploy<ComptrollerImpl>(
          world,
          from,
          []
        ),
    ...
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      async (world, { name }) => {
        return {
          invokation: await ComptrollerG1Contract.deploy<ComptrollerImpl>(
            world,
            from,
            []
          ),
    ...
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      async (world, { name }) => {
        return {
          invokation: await ComptrollerG2Contract.deploy<ComptrollerImpl>(
            world,
            from,
            []
          ),
    ...
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      async (world, { name }) => {
        return {
          invokation: await ComptrollerG3Contract.deploy<ComptrollerImpl>(
            world,
            from,
            []
          ),
    ...
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      async (world, { name }) => {
        return {
          invokation: await ComptrollerG4Contract.deploy<ComptrollerImpl>(
            world,
            from,
            []
          ),
    ...
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      async (world, { name }) => {
        return {
          invokation: await ComptrollerG5Contract.deploy<ComptrollerImpl>(
            world,
            from,
            []
          ),
    ...
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      async (world, { name }) => {
        return {
          invokation: await ComptrollerG6Contract.deploy<ComptrollerImpl>(
            world,
            from,
            []
          ),
    ...
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      async (world, { name }) => {
        return {
          invokation: await ComptrollerContract.deploy<ComptrollerImpl>(
            world,
            from,
            []
          ),
    ...
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      [new Arg("name", getStringV)],
      async (world, { name }) => ({
        invokation: await ComptrollerBorkedContract.deploy<ComptrollerImpl>(
          world,
          from,
          []
        ),
    ...
    new Fetcher<{ name: StringV }, ComptrollerImplData>(
      ...
      async (world, { name }) => {
        if (world.isLocalNetwork()) {
          ...
          return {
            invokation: await ComptrollerScenarioContract.deploy<
              ComptrollerImpl
            >(world, from, []),
            name: name.val,
            contract: "ComptrollerScenario",
