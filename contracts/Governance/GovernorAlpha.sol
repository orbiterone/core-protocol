...
contract GovernorAlpha {
    ...
    string public constant name = "Orbiter Governor Alpha";
    ...
    /// @notice The address of the Orbiter Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Orbiter governance token
